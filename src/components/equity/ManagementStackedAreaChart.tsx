...
const ManagementStackedAreaChart: React.FC = () => {
	const legendPayload = [
		{ value: 'Research', type: 'square' as const, id: 'research', color: 'hsl(var(--chart-4))' },
		{ value: 'Production', type: 'square' as const, id: 'production', color: 'hsl(var(--chart-2))' },
		{ value: 'Acquisitions', type: 'square' as const, id: 'acquisitions', color: 'hsl(var(--chart-1))' },
	];
				...
				<ResponsiveContainer width="100%" height={600}>
					...
					>
						...
						<Legend 
							...
							wrapperStyle={{ paddingTop: '20px', display: 'flex', justifyContent: 'center', gap: 64 }} // Increased gap between legend items
							align="center" 
